  ...
  $id_roles = $_POST["id_roles"][0];
  unset($_POST["id_roles"]);
  $requests=get_all_requests($_POST);
 ?>
                      ...
                      <tbody>
                        <?php  
                          for ($i=0;$i<count($requests);$i++)
                          {
                            ...
                            <tr>
                              <td>
                              	<span <?php if($id_roles==1) {echo ' onclick="edit_request_status(this,'.$requests[$i]['id_requests'].')"';} ?> style="cursor:pointer;">
