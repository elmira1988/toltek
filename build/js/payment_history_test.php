$(document).ready(function()
{
	...
	{
		$("button[name='allPay']").addClass("active");
	}
...
function get_data_by_filter()  
{
	...
	var arr=filter_data();
	$.post("build/php/get_table_payments.php",{data:JSON.stringify(arr)}, 
		function(data){
...
{	
	...
	{
		$("span#summa").html(' &nbsp;&nbsp;&nbsp;&nbsp;<small>сумма </small>'+$("input[name='summa']").val().replace(/(\d)(?=(\d\d\d)+([^\d]|$))/g, '$1 ')); 
	}
