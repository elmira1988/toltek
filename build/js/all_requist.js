...
function filter_data()
{
	...
	$("#filter-block").find("[name='id_requests']:checked,[name='class_number']:checked,[name='attend']:checked,[name='id_request_status']:checked,[name='id_courses']:checked").each(function(){
