...
(function (global, factory) {
  ...
  Parsley.addMessages('en', {
    defaultMessage: "Это значение кажется ошибочным",
    type: {
      email: "Введите действительный адрес email",
      url: "Введите действительное URL",
      number: "This value should be a valid number.",
      integer: "Это значение должно быть действительным числом.",
      digits: "Это значение должно быть числом.",
      alphanum: "Это знаечние должно быть буквенно-цифровым."
    },
    notblank: "Это значение не должно быть пустым.",
    required: "Это обязательное поле.",
    pattern: "Это значение кажется недействительным.",
    min: "Это значение должно быть больше или равно %s.",
    max: "Это значение должно быть меньше или равно to %s.",
    range: "Это значение должно быть между %s и %s.",
    minlength: "Это значение слишком короткое. Должно быть %s символов или больше.",
    maxlength: "Это значение длины недопустимо. Длина должна быть от %s до %s символов.",
    mincheck: "Вы должны выбрать как минимум %s вариантов.",
    maxcheck: "Вы должны выбрать %s или меньше.",
